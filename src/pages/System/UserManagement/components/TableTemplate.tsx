...
const TableTemplate: FC = () => {
  ...
  const columns: ProColumns<API.USERMANAGEMENT>[] = [
    ...
    },
    {
      ...
      render: (text) => (
        <Space>
          <Tag icon={<IconFont type="icon-role-management" className={PrimaryColor} />}>{text}</Tag>
        </Space>
      ),
    },
    {
      ...
      render: (text) => (
        <Space>
          <Tag icon={<IconFont type="icon-organization" className={PrimaryColor} />}>{text}</Tag>
        </Space>
      ),
    },
    {
      ...
      render: (text) => (
        <Space>
          <Tag icon={<IconFont type="icon-jobs-management" className={PrimaryColor} />}>{text}</Tag>
        </Space>
      ),
    },
    {
